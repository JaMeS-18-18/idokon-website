...
(function () {
  ...
  function getDict(lang) {
    const def = 'uz';
    return (i18n && i18n[lang]) ? i18n[lang] : (i18n && i18n[def]) ? i18n[def] : featureTranslations.uz;
  }
      ...
      return `
        <div class="col-lg-6 col-xl-3">
          <div class="cs_iconbox cs_style_1 h-100">
            ...
            <a href="#features" aria-label="${more}" class="cs_text_btn cs_text_accent">
              ${more}
  ...
  // 6) Globalga chiqaramiz — til o‘zgarganda lang.js ichidan chaqirasiz
  window.renderFeatures = renderFeatures;

  // 7) Avto-init: hozirgi tilni topib, bir marta chizamiz
